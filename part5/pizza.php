...
<body>
  ...
  <ul>
    <li><strong>Name:</strong> <?php echo htmlspecialchars($_POST['customername']); //input your PHP code here 
                                ?></li>
    <li><strong>Address:</strong> <?php echo htmlspecialchars($_POST['address']); //input your PHP code here 
                                  ?></li>
    <li><strong>Telephone number:</strong> <?php echo htmlspecialchars($_POST['telephone']); //input your PHP code here 
                                            ?></li>
